...
var RenderEvent = function RenderEvent(_ref) {
  ...
  switch (event) {
    case 'prideMonth':
    case 'saintValentine':
      return /*#__PURE__*/React__default["default"].createElement(HeartVariant, {
        isSaintValentineEvent: event === 'saintValentine',
        stylePathDropShadow: stylePathDropShadow
      });

    case 'saintPatrick':
      return /*#__PURE__*/React__default["default"].createElement(SaintPatrickVariant, {
        stylePathDropShadow: stylePathDropShadow
      });

    case 'easter':
      return /*#__PURE__*/React__default["default"].createElement(EasterVariant, null);

    case 'spring':
      return /*#__PURE__*/React__default["default"].createElement(SpringVariant, {
        stylePathDropShadow: stylePathDropShadow
      });

    case 'summer':
      return /*#__PURE__*/React__default["default"].createElement(SummerVariant, null);

    case 'frenchNationalDay':
      return /*#__PURE__*/React__default["default"].createElement(FrenchNationalDayVariant, null);

    case 'frenchMusicDay':
      return /*#__PURE__*/React__default["default"].createElement(FrenchMusicDayVariant, null);

    case 'halloween':
      return /*#__PURE__*/React__default["default"].createElement(HalloweenVariant, null);

    case 'pinkOctober':
      return /*#__PURE__*/React__default["default"].createElement(PinkOctoberVariant, null);

    case 'movember':
      return /*#__PURE__*/React__default["default"].createElement(MovemberVariant, null);
...
var LogoFlatchr = function LogoFlatchr(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(Svg__default["default"], {
    ...
    fill: color
  }), !noEventRender && /*#__PURE__*/React__default["default"].createElement(RenderEvent, {
    event: event || helper.date.getEventName(new Date())
...
LogoFlatchr.propTypes = {
  ...
  noEventRender: PropTypes__default["default"].bool,
...
var CallPaulIcon = function CallPaulIcon(_ref) {
  var _ref$color = _ref.color;
      _ref$color === void 0 ? systemDesign.theme.colors.textPrimary : _ref$color;
  ...
  return /*#__PURE__*/React__default["default"].createElement(Svg__default["default"], {
    ...
    d: "M3.7001 3.39996C3.7001 3.39996 3.7001 3.99996 3.7001 6.19996C3.5001 6.19996 3.0001 6.29996 2.5001 6.19996C2.3001 6.09996 2.1001 5.99996 2.0001 5.99996C1.9001 5.89996 1.7001 5.79996 1.6001 5.59996C1.4001 5.39996 1.5001 5.19996 1.5001 4.79996C1.5001 4.29996 1.5001 3.99996 1.8001 3.79996C1.9001 3.69996 2.0001 3.69996 2.1001 3.69996C2.5001 3.49996 2.8001 3.49996 3.1001 3.49996C3.3001 3.49996 3.7001 3.49996 3.7001 3.39996Z",
    stroke: "#0A1F33",
    "stroke-width": "0.5941",
    "stroke-miterlimit": "10"
  }), /*#__PURE__*/React__default["default"].createElement(Svg.Path, {
    d: "M9.7002 3.39997C9.7002 3.39997 9.7002 3.29997 9.7002 3.39997C9.7002 3.39997 9.7002 3.99997 9.7002 6.19997C9.9002 6.19997 10.4002 6.29997 10.9002 6.19997C11.1002 6.19997 11.3002 6.09997 11.4002 5.99997C11.5002 5.89997 11.7002 5.79997 11.8002 5.59997C12.0002 5.39997 12.0002 5.19997 12.0002 4.79997C12.0002 4.29997 12.0002 3.99997 11.7002 3.79997C11.6002 3.69997 11.5002 3.69997 11.4002 3.59997C11.0002 3.39997 10.7002 3.39997 10.4002 3.39997C10.2002 3.39997 9.8002 3.49997 9.7002 3.39997Z",
    stroke: "#0A1F33",
    "stroke-width": "0.5941",
    "stroke-miterlimit": "10"
  }), /*#__PURE__*/React__default["default"].createElement(Svg.Path, {
    d: "M9.2998 8.79999C9.2998 8.79999 9.3998 8.79999 9.4998 8.79999C9.4998 8.89999 9.6998 8.89999 9.9998 8.99999C10.0998 9.09999 10.2998 9.09999 10.4998 9.29999C10.4998 9.29999 10.5998 9.39999 10.7998 9.59999C10.8998 9.69999 10.9998 9.79999 11.0998 9.99999C11.1998 10.2 11.2998 10.4 11.2998 10.7C11.3998 11 11.3998 11.2 11.4998 11.4C11.4998 11.6 11.5998 11.9 11.5998 12.3C11.5998 12.3 11.6998 13 11.7998 13.3V13.4C11.7998 13.5 11.8998 13.5 11.8998 13.6C11.8998 13.7 11.9998 13.7 11.9998 13.7C12.0998 13.8 12.0998 13.8 12.1998 13.9C12.2998 13.9 12.2998 14 12.3998 14C12.3998 14 12.3998 14 12.4998 14.1C12.6998 14.2 12.6998 14.2 12.6998 14.2C12.6998 14.2 12.7998 14.3 12.8998 14.3C12.8998 14.3 12.9998 14.4 13.0998 14.5C13.0998 14.6 13.1998 14.6 13.1998 14.7C13.1998 14.8 13.1998 14.9 13.1998 15C13.1998 15 13.0998 15.2 12.9998 15.3C12.7998 15.6 12.3998 15.5 12.2998 15.5C12.1998 15.5 11.9998 15.5 11.7998 15.4C11.6998 15.4 11.3998 15.3 11.1998 15.2C11.0998 15.1 10.8998 15.1 10.6998 14.9C10.3998 14.7 10.2998 14.5 10.1998 14.3C10.0998 14.2 9.9998 14 9.8998 13.7C9.7998 13.5 9.7998 13.4 9.6998 13.2C9.6998 13.1 9.6998 13.1 9.5998 13C9.5998 12.9 9.4998 12.8 9.4998 12.5C9.3998 12.2 9.3998 12.1 9.2998 12C9.2998 12 9.2998 11.9 9.1998 11.8C9.0998 11.6 9.0998 11.7 9.0998 11.6C9.0998 11.6 9.0998 11.6 8.9998 11.5C8.9998 11.5 8.9998 11.5 8.8998 11.5C8.8998 11.5 8.8998 11.5 8.7998 11.5C9.0998 10.4 9.1998 9.59999 9.2998 8.79999Z",
    fill: "white"
  }), /*#__PURE__*/React__default["default"].createElement(Svg.Path, {
    d: "M9.0998 11L6.7998 11.4C6.7998 11.5 6.7998 11.5 6.7998 11.7C6.7998 12 6.8998 12.6 7.1998 13.5C7.2998 13.7 7.2998 13.9 7.3998 14.2C7.7998 15.1 8.1998 15.6 8.2998 15.7C8.2998 15.7 8.3998 15.8 8.4998 15.9L8.5998 16L8.6998 16.1C8.8998 16.3 8.9998 16.3 8.9998 16.3C8.9998 16.3 9.0998 16.4 9.1998 16.4C9.2998 16.4 9.2998 16.4 9.3998 16.4C9.4998 16.4 9.5998 16.4 9.7998 16.2C9.9998 16.2 9.9998 16 9.9998 16C9.9998 16 9.9998 15.9 9.9998 15.8V15.7C9.9998 15.6 9.9998 15.6 9.8998 15.5C9.7998 15.4 9.7998 15.3 9.6998 15.3C9.6998 15.3 9.5998 15.1 9.4998 14.9C9.3998 14.8 9.3998 14.6 9.2998 14.5C9.1998 14.3 9.1998 14.1 9.0998 14C8.9998 13.8 8.9998 13.6 8.9998 13.5C8.9998 13.4 8.9998 13.3 8.8998 13C8.8998 12.8 8.8998 12.7 8.7998 12.6C8.7998 12.5 8.7998 12.4 8.7998 12.1C8.7998 11.8 8.7998 11.8 8.7998 11.7C9.0998 11.6 9.0998 11.3 9.0998 11Z",
    fill: "white"
  }), /*#__PURE__*/React__default["default"].createElement(Svg.Path, {
    d: "M4.4 11L6.7 11.4C6.7 11.5 6.7 11.5 6.7 11.7C6.7 12 6.6 12.6 6.3 13.5C6.2 13.8 6.1 14 6 14.2C5.6 15.1 5.2 15.6 5.1 15.7C5.1 15.7 5 15.8 4.9 15.9L4.8 16L4.7 16.1C4.6 16.2 4.6 16.2 4.5 16.3C4.5 16.3 4.4 16.4 4.3 16.4C4.2 16.4 4.2 16.4 4.1 16.4C4 16.4 3.9 16.4 3.7 16.2C3.5 16.2 3.5 16 3.5 16C3.5 15.9 3.5 15.9 3.5 15.8V15.7C3.5 15.6 3.5 15.6 3.6 15.5C3.7 15.4 3.7 15.3 3.8 15.3C3.8 15.3 3.9 15.1 4 14.9C4 14.7 4 14.6 4.1 14.5C4.2 14.3 4.2 14.1 4.3 14C4.4 13.8 4.4 13.6 4.4 13.5C4.4 13.4 4.4 13.3 4.5 13C4.5 12.8 4.5 12.7 4.6 12.6C4.6 12.5 4.6 12.4 4.6 12.1C4.6 11.8 4.6 11.8 4.6 11.7C4.5 11.6 4.4 11.3 4.4 11Z",
    fill: "white"
  }), /*#__PURE__*/React__default["default"].createElement(Svg.Path, {
    d: "M4.1998 8.79999C4.1998 8.79999 4.0998 8.79999 3.9998 8.79999C3.9998 8.89999 3.7998 8.89999 3.4998 8.99999C3.3998 9.09999 3.1998 9.19999 2.9998 9.39999C2.9998 9.39999 2.8998 9.49999 2.6998 9.69999C2.5998 9.79999 2.4998 9.89999 2.3998 10.1C2.2998 10.3 2.1998 10.5 2.1998 10.8C2.0998 11.1 2.0998 11.3 1.9998 11.5C1.9998 11.7 1.9998 12 1.8998 12.4C1.8998 12.4 1.7998 13.1 1.6998 13.4V13.5C1.6998 13.6 1.5998 13.6 1.5998 13.7C1.5998 13.8 1.4998 13.8 1.4998 13.8C1.3998 13.9 1.3998 13.9 1.2998 14C1.1998 14 1.1998 14.1 1.0998 14.1C1.0998 14.1 1.0998 14.1 0.999805 14.2C0.799805 14 0.799805 14 0.799805 14C0.799805 14 0.699805 14.1 0.599805 14.1C0.599805 14.1 0.499805 14.2 0.399805 14.3C0.399805 14.4 0.299805 14.4 0.299805 14.5C0.299805 14.6 0.299805 14.7 0.299805 14.8C0.299805 14.8 0.399805 15 0.499805 15.1C0.699805 15.4 1.0998 15.3 1.1998 15.3C1.2998 15.3 1.4998 15.3 1.6998 15.2C1.7998 15.2 2.0998 15.1 2.2998 15C2.3998 14.9 2.5998 14.9 2.7998 14.7C3.0998 14.5 3.1998 14.3 3.2998 14.1C3.3998 14 3.4998 13.8 3.5998 13.5C3.6998 13.3 3.6998 13.2 3.7998 13C3.7998 12.9 3.7998 12.9 3.8998 12.8C3.8998 12.7 3.9998 12.6 3.9998 12.3C3.9998 12 4.0998 11.9 4.0998 11.8C4.0998 11.8 4.0998 11.7 4.1998 11.6C4.2998 11.4 4.2998 11.5 4.2998 11.4C4.2998 11.4 4.2998 11.4 4.3998 11.3C4.3998 11.3 4.3998 11.3 4.4998 11.3C4.4998 11.3 4.4998 11.3 4.5998 11.3C4.3998 10.4 4.2998 9.59999 4.1998 8.79999Z",
    fill: "white"
  }), /*#__PURE__*/React__default["default"].createElement(Svg.Path, {
    d: "M7.09988 11.5H7.39988C7.39988 11.4 8.99988 11.3 8.99988 11.3H9.09988C9.09988 11.2 9.19988 11.2 9.19988 11.2C9.19988 11.2 9.29988 8.80001 9.39988 8.80001C9.39988 8.40001 9.59988 7.80001 9.59988 7.80001C9.69988 7.50001 9.79988 7.30001 9.99988 7.10001C9.99988 7.00001 10.0999 6.90001 10.0999 6.80001C10.2999 6.50001 10.4999 6.00001 10.5999 5.50001C10.6999 5.20001 10.6999 5.00001 10.6999 5.00001C10.7999 3.20001 9.69988 2.20001 9.69988 2.20001C8.39988 0.800013 6.79988 0.900013 6.69988 0.900013C6.59988 0.900013 4.99988 0.700013 3.79988 2.10001C3.79988 2.10001 2.69988 3.20001 2.79988 4.90001C2.79988 4.90001 2.79988 5.60001 3.39988 6.70001L3.89988 7.70001C3.89988 7.70001 4.19988 8.30001 4.09988 8.70001C4.09988 8.70001 4.19988 8.90001 4.19988 9.10001C4.29988 9.80001 4.39988 11 4.39988 11",
    fill: "white"
  }), /*#__PURE__*/React__default["default"].createElement(Svg.Path, {
    d: "M3.1001 3.80001C3.1001 3.60001 3.1001 3.40001 3.1001 3.10001C3.2001 2.80001 3.3001 2.10001 4.0001 1.50001C5.1001 0.500007 6.8001 0.600007 6.9001 0.600007C8.3001 0.700007 9.2001 1.40001 9.4001 1.50001C10.3001 2.20001 10.3001 3.10001 10.4001 3.40001C10.4001 3.50001 10.4001 3.70001 10.4001 3.80001",
    stroke: "#0A1F33",
    "stroke-width": "0.6084",
    "stroke-miterlimit": "10"
  }), /*#__PURE__*/React__default["default"].createElement(Svg.Path, {
    d: "M10.8003 6.10004C10.3003 6.80004 10.0003 7.10004 10.0003 7.20004L9.90029 7.30004C9.90029 7.40004 9.80029 7.40004 9.80029 7.50004C9.50029 7.70004 8.90029 7.70004 8.40029 7.70004C8.00029 7.70004 7.90029 7.70004 7.60029 7.70004C7.30029 7.80004 7.30029 8.00004 7.00029 8.00004C6.80029 8.10004 6.50029 8.10004 6.00029 8.00004C6.00029 8.00004 5.80029 7.90004 5.80029 7.80004C5.80029 7.70004 5.90029 7.50004 6.10029 7.50004C6.20029 7.50004 6.30029 7.50004 6.40029 7.40004C6.70029 7.40004 6.90029 7.30004 7.10029 7.40004C7.20029 7.40004 7.30029 7.40004 7.40029 7.50004C7.50029 7.60004 7.60029 7.70004 7.60029 7.70004",
    stroke: "#0A1F33",
    "stroke-width": "0.5941",
    "stroke-miterlimit": "10"
  }));
...
exports.CallPaulIcon = CallPaulIcon;
...
exports.CodeBranchIcon = CodeBranchIcon;
...
exports.SmileGrinHeartsIcon = SmileGrinHeartsIcon;
